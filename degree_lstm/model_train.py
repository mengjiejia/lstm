...
directory = 'model2/min_max/normal_training_5to6_degree'
...
# training result
myModule.two_line('training result', x_label, y_label, train_y_prediction[0:100], y_training_normal[0:100],
                  'training result',
                  output_dir)

# validation result
myModule.two_line('validation result', x_label, y_label, valid_y_prediction[0:100], y_valid_normal[0:100],
                  'validation result',
                  output_dir)
